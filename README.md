...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/x64x32/VapeV4ForRoblox/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/x64x32/VapeV4ForRoblox/refs/heads/main/NewMainScript.lua)
3. Ensuring no external script is conflicting with vape.

## Developers & Credits
[7GrandDad](https://github.com/x64x32) - Lead maintainer of the project - vaperoblox on Discord
<br/>
